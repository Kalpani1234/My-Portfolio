                            ...
                            >
                                ...
                                <div className="flex flex-col flex-1 gap-2">
                                    ...
                                    <p className="text-slate-500">
                                        ...
                                        Prodigy Infortech , gaining hands-on
                                        experience in web development.
                                        Contributed to projects, enhancing
                                        skills in coding, problem-solving,
                                        and collaboration.
            ...
            <div className="min-h-screen">
                ...
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <p className="mb-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
                        Hey there! I&apos;m Nethma Kalpani, currently working
                        as a Web Development Intern at Prodigy InfoTech. Yep, 
                        you got it right—I&apos;m from the vibrant shores of 
                        Sri Lanka!
                    </p>
