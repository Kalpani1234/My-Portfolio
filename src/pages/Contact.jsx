      ...
      <div className="flex flex-col">
        ...
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
          ...
          <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">
            I welcome the opportunity to connect with you. Whether you have
            inquiries about my work, collaboration proposals, or just want to
            say hello, feel free to reach out. I am always eager to engage with
          ...
          <div className="px-4 mx-auto text-center md:max-w-screen-md lg:max-w-screen-lg lg:px-36">
            ...
            <div className="flex flex-wrap justify-center items-center mt-8 text-gray-500 sm:justify-between">
              <Link
                ...
                to="https://web.facebook.com/Nethma.On.Fb"
              >
                <FaFacebook className="h-8 w-8" />
              </Link>
              <Link
                className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400"
                to="https://github.com/kalpani1234"
              >
                <FaGithub className="h-8 w-8" />
              </Link>
              <Link
                className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400"
                to="https://www.linkedin.com/in/nethma-kalpani-b45a10226/"
              >
                <FaLinkedin className="h-8 w-8" />
              </Link>
              <Link
                className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400"
                to="https://www.instagram.com/nethmakalpani"
              >
                <FaInstagram className="h-8 w-8" />
              </Link>
              <Link
                className="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400"
                to="mailto:kalpani4lk@gmail.com"
              >
