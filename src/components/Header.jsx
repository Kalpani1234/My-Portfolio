            ...
            <header>
                ...
                >
                    ...
                    <div className="hidden lg:flex lg:gap-x-12">
                        <Link
                            to="/"
                            className={`text-sm font-semibold leading-6 block py-2 pr-4 pl-3 lg:text-primary-700 lg:p-0 text-gray-900 dark:text-white ${lastPart === "" ? "rounded-none border-b-2 border-black dark:border-white" : ""}`}
                        >
                            Home
                        </Link>
                        <Link
                            to="/projects"
                            className={`text-sm font-semibold leading-6 block py-2 pr-4 pl-3 lg:text-primary-700 lg:p-0  text-gray-900 dark:text-white ${lastPart === "projects" ? "rounded-none border-b-2 border-black dark:border-white" : ""}`}
                        >
                            Projects
                        </Link>
                        <Link
                            to="/resume"
                            className={`text-sm font-semibold leading-6 block py-2 pr-4 pl-3 lg:text-primary-700 lg:p-0  text-gray-900 dark:text-white ${lastPart === "resume" ? "rounded-none border-b-2 border-black dark:border-white" : ""}`}
                        >
                            Resume
                        </Link>
                        <Link
                ...
                >
                    ...
                    <div className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10 dark:bg-black">
